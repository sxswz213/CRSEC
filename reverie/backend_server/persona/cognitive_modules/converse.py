...
def generate_one_utterance(maze, init_persona, target_persona, retrieved, curr_chat, norm_conf_res): 
  # Chat version optimized for speed via batch generation
  curr_context = (f"{init_persona.scratch.name} " + 
              f"was {init_persona.scratch.act_description} " + 
              f"when {init_persona.scratch.name} " + 
  ...
  print ("July 23 5")
  x = run_gpt_generate_iterative_chat_utt(maze, init_persona, target_persona, retrieved, curr_context, curr_chat, norm_conf_res)[0]
...
def agent_chat_v2(maze, init_persona, target_persona, norm_conf_res): 
  ...
  for i in range(5): 
    ...
    utt, end = generate_one_utterance(maze, init_persona, target_persona, retrieved, curr_chat, norm_conf_res)
    ...
    utt, end = generate_one_utterance(maze, target_persona, init_persona, retrieved, curr_chat, norm_conf_res)
