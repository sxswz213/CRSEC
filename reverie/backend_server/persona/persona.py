...
class Persona: 
  def __init__(self, name, folder_mem_saved=False):
    ...
    norm_saved = f"{folder_mem_saved}/norms"
    self.norm_database = NormDatabase(norm_saved,self.scratch.norm_count,self.scratch.act_norm_count,self)
  ...
  def plan(self, maze, personas, new_day, retrieved, perceived):
    """
    ...
    """
    return plan(self, maze, personas, new_day, retrieved, perceived)
  ...
  def move(self, maze, personas, curr_tile, curr_time):
    ...
    if not self.scratch.curr_time: 
      new_day = "First day"
      # to test compliance, should be removed
      #new_day = "New day"
      print("NEWWWWWWWWWWDAYYYYYYYYYYYYY:", new_day)
