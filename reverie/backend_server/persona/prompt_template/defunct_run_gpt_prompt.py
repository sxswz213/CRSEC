...
def run_gpt_prompt_wake_up_hour(persona, test_input=None, verbose=False): 
  ...
  print("run_fuc:run_gpt_prompt_wake_up_hour(persona, test_input=None, verbose=False)")
...
def run_gpt_prompt_daily_plan(persona, 
  ...
  prompt = generate_prompt(prompt_input, prompt_template)
  fail_safe = get_fail_safe()
  print("run_fuc:run_gpt_prompt_daily_plan(persona, wake_up_hour, test_input=None, verbose=False)")
  #output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
                                   #__func_validate, __func_clean_up)
  output = ChatGPT_safe_generate_response_OLD(prompt, 3, fail_safe,
                                              __func_validate, __func_clean_up)
...
def run_gpt_prompt_event_triple(action_description, persona, verbose=False): 
  ...
  #output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
  #                                 __func_validate, __func_clean_up)
  print("run_fuc:run_gpt_prompt_event_triple(action_description, persona, verbose=False)")
  output = ChatGPT_safe_generate_response_OLD(prompt, 3, fail_safe,
                                              __func_validate, __func_clean_up)
...
def run_gpt_prompt_act_obj_event_triple(act_game_object, act_obj_desc, persona, verbose=False): 
  ...
  #output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
  #                                 __func_validate, __func_clean_up)
  print("run_fuc:run_gpt_prompt_act_obj_event_triple(act_game_object, act_obj_desc, persona, verbose=False)")
  output = ChatGPT_safe_generate_response_OLD(prompt, 3, fail_safe,
                                              __func_validate, __func_clean_up)
...
def run_gpt_prompt_focal_pt(persona, statements, n, test_input=None, verbose=False): 
  ...
  #output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
  #                                 __func_validate, __func_clean_up)
  print("run_fuc:run_gpt_prompt_focal_pt(persona, statements, n, test_input=None, verbose=False)")
  output = ChatGPT_safe_generate_response_OLD(prompt, 3, fail_safe,
                                              __func_validate, __func_clean_up)
...
def run_gpt_prompt_insight_and_guidance(persona, statements, n, test_input=None, verbose=False): 
  ...
  #output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
  #                                 __func_validate, __func_clean_up)
  print("run_fuc:run_gpt_prompt_insight_and_guidance(persona, statements, n, test_input=None, verbose=False)")
  output = ChatGPT_safe_generate_response_OLD(prompt, 3, fail_safe,
                                              __func_validate, __func_clean_up)
...
def run_gpt_prompt_planning_thought_on_convo(persona, all_utt, test_input=None, verbose=False): 
  ...
  #output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
                                   #__func_validate, __func_clean_up)
  print("run_fuc:run_gpt_prompt_planning_thought_on_convo(persona, all_utt, test_input=None, verbose=False)")
  output = ChatGPT_safe_generate_response_OLD(prompt, 3, fail_safe,
                                              __func_validate, __func_clean_up)
